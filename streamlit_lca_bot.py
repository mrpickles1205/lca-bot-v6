...
st.title("📘 LCA Bot Pro")
product_input = st.text_input("Enter a product name:", "Electric Toothbrush")

if st.button("Generate Report"):
    with st.spinner("Creating full ISO-compliant LCA report..."):
        report_path = generate_lca_report(product_input)
